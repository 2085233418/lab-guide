...
这一步骤开始，将使用**"chapters0-3" **环境，请点击链接下载chapters/chapters3:[第0-3章节环境](#)
...
在0.2章节中，我们已经编写了qemu的启动脚本，而现在我们已经将qemu的启动任务交给了**config.toml**文件但为了保证项目的完整性，我们仍将“run.sh”移动到ErrorOS路径下：
